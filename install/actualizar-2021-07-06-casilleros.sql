...
INSERT INTO casilleros (operativo, id_casillero, padre, tipoc, casillero, orden, nombre, tipovar, longitud, tipoe, aclaracion, salto, unidad_analisis, cantidad_resumen, irrepetible, despliegue, ver_id, optativo, formulario_principal, var_name, var_name_especial, expresion_habilitar, valor_ns_nc, valor_sin_dato, leer, calculada, libre, especial) VALUES
  ...
  ('ESECO', 'V1_2', 'V', 'P', 'V1_2', 1411, '¿En qué fecha recibió la primera dosis de la vacuna?', 'fecha', NULL, NULL, 'DD/MM/AAAA', NULL, NULL, NULL, true, NULL, NULL, NULL, NULL, 'v1_2', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
  ('ESECO', 'V_Filtro', 'V', 'FILTRO', 'V_Filtro', 1414, 'Aplicar si en la pregunta V1_1 contestó la opción 2. "Dos dosis". El resto pasa a pregunta V1_4', NULL, NULL, NULL, NULL, 'V1_4', NULL, NULL, true, NULL, NULL, NULL, NULL, NULL, NULL, 'v1_1=1', NULL, NULL, NULL, NULL, NULL, NULL),
  ('ESECO', 'V1_3', 'V', 'P', 'V1_3', 1417, '¿En qué fecha recibió la segunda dosis de la vacuna?', 'fecha', NULL, NULL, 'DD/MM/AAAA', NULL, NULL, NULL, true, NULL, NULL, NULL, NULL, 'v1_3', NULL, 'v1_1=2', NULL, NULL, NULL, NULL, NULL, NULL),
