...
grant select, insert, update, delete on "sincronizaciones" to eseco_user;
grant all on "sincronizaciones" to eseco_owner;
...
GRANT USAGE, SELECT ON SEQUENCE "sincronizacines_seq" TO eseco_user;
